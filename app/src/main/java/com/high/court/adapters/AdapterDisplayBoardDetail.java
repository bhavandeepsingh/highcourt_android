...
public class AdapterDisplayBoardDetail extends RecyclerView.Adapter<AdapterDisplayBoardDetail.ViewHolder> {
    Context context;
    String[] get_judgesnamelist;
    String[] get_courtroomlist;

    public AdapterDisplayBoardDetail(Context ctx, String[] judgesnamelist, String[] courtroomlist) {
        super();
